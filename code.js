// this changes the text when the button is pressed //
function changeHeadingText(){
    document.getElementById("heading");heading.innerHTML = "JavaScript is awesome!";
}
function edit(){
...
// This rolls the 6 dice images into random
    var pictures=[];
